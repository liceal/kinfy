!function() {
    ...
    var e = {
      ...
      , r = function() {
        ...
        function t(e) {
            ...
            e.find(".owl-stage-outer").children(":eq(0)").unwrap()
        }
        e(jQuery("#owl1")),
      ...
      , l = function() {
        ...
        jQuery(".probootstrap-animate").waypoint(function(t) {
            "down" !== t || jQuery(this.element).hasClass("probootstrap-animated") || (e++,
      ...
      , c = function(e) {
        for (var t = function(e) {
            for (var t, o, n, a, i = e.childNodes, r = i.length, s = [], u = 0; u < r; u++)
                1 === (t = i[u]).nodeType && (n = (o = t.children[0]).getAttribute("data-size").split("x"),
                a = {
            ...
            new PhotoSwipe(s,PhotoSwipeUI_Default,r,i).init())
        }, a = document.querySelectorAll(e), i = 0, r = a.length; i < r; i++)
    ...
    jQuery(document).ready(function() {
        ...
        u(),
        l(),
        jQuery(".probootstrap-gallery").length > 0 && c(".probootstrap-gallery"),
        d(),
        f(),
        r(),
        t(),
